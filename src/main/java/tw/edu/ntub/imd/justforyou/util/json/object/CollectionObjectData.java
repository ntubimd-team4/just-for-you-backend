package tw.edu.ntub.imd.justforyou.util.json.object;

import com.fasterxml.jackson.databind.JsonNode;
import tw.edu.ntub.imd.justforyou.dto.CodeEntry;
...
public class CollectionObjectData implements ResponseData {
    private final tw.edu.ntub.imd.justforyou.util.json.object.ObjectData objectData;

    public CollectionObjectData() {
        this(new tw.edu.ntub.imd.justforyou.util.json.object.ObjectData());
    }

    protected CollectionObjectData(tw.edu.ntub.imd.justforyou.util.json.object.ObjectData objectData) {
    ...
    public <T> CollectionObjectData add(String key, Collection<T> resource, BiConsumer<tw.edu.ntub.imd.justforyou.util.json.object.ObjectData, T> addObjectDataConsumer) {
    ...
    public <T> Consumer<T> addArrayAndAddObjectToNewArray(String key, BiConsumer<tw.edu.ntub.imd.justforyou.util.json.object.ObjectData, T> addObjectDataConsumer) {
