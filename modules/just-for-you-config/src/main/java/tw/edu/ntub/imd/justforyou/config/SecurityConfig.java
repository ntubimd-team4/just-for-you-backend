...
import tw.edu.ntub.imd.justforyou.config.entrypoint.CustomEntryPoint;
import tw.edu.ntub.imd.justforyou.config.filter.CustomLoginFilter;
import tw.edu.ntub.imd.justforyou.config.filter.JwtAuthenticationFilter;
import tw.edu.ntub.imd.justforyou.config.handler.CustomAuthenticationSuccessHandler;
import tw.edu.ntub.imd.justforyou.config.handler.CustomLogoutSuccessHandler;
...
//                .anyRequest().permitAll()
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("https://justforyou.ntub.edu.tw"));
